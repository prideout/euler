...
~/github/filament/out/cmake-release/tools/matc/matc \
    -o ../../docs/eulers_gem/materials/step1.filamat src/step1.mat

~/github/filament/out/cmake-release/tools/matc/matc \
    -o ../../docs/eulers_gem/materials/step2.filamat src/step2.mat

~/github/filament/out/cmake-release/tools/matc/matc \
    -o ../../docs/eulers_gem/materials/step1_cylinder_back.filamat \
    src/step1_cylinder_back.mat

~/github/filament/out/cmake-release/tools/matc/matc \
    -o ../../docs/eulers_gem/materials/step1_cylinder_front.filamat \
